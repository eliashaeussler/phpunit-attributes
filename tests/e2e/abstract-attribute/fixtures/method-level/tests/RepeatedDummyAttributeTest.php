...
/**
 * RepeatedDummyAttributeTest.
 *
 * @author Elias Häußler <elias@haeussler.dev>
 * @license GPL-3.0-or-later
 */
final class RepeatedDummyAttributeTest extends Framework\TestCase
{
    #[Framework\Attributes\Test]
    #[Tests\Fixtures\DummyAttribute('foo')]
    #[Tests\Fixtures\DummyAttribute('baz')]
