...
/**
 * RequiresPackageAttributeFailsOnUnsatisfiedRequirementTest.
 *
 * @author Elias Häußler <elias@haeussler.dev>
 * @license GPL-3.0-or-later
 */
final class RequiresPackageAttributeFailsOnUnsatisfiedRequirementTest extends Framework\TestCase
{
