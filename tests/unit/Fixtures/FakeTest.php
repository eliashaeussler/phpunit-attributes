 ...
 */
#[Attribute\RequiresPackage('phpunit/phpunit', '< 11', 'PHPUnit < 11 must be installed')]
#[Attribute\RequiresPackage('phpstan/phpstan')]
final class FakeTest extends Framework\TestCase
{
